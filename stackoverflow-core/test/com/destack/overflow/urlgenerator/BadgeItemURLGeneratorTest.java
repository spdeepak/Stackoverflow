...
public class BadgeItemURLGeneratorTest {
    ...
    public void testNormalBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String normalURL = "https://api.stackexchange.com/2.2/badges?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&order=asc&sort=rank&min=gold&max=bronze&site=stackoverflow&filter=!-*f(6qLMLow-";
    ...
    public void testNameBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String nameURL = "https://api.stackexchange.com/2.2/badges/name?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&order=desc&sort=rank&min=gold&max=bronze&site=stackoverflow&filter=!-*f(6qLMLow-";
    ...
    public void testTagBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String nameURL = "https://api.stackexchange.com/2.2/badges/tags?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&order=desc&sort=rank&min=gold&max=bronze&site=stackoverflow&filter=!-*f(6qLMLow-";
    ...
    public void testRecipientBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String nameURL = "https://api.stackexchange.com/2.2/badges/recipients?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&site=stackoverflow&filter=!-*f(6qLMLow-";
    ...
    public void testIdRecipientBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String nameURL = "https://api.stackexchange.com/2.2/badges/222/recipients?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&site=stackoverflow&filter=!-*f(6qLMLow-";
    ...
    public void testIdBadgeRetriever() throws ParseException, MalformedURLException, IllegalAccessException {
        String nameURL = "https://api.stackexchange.com/2.2/badges/222?page=1&pagesize=100&fromdate=1462057200&todate=1463698800&order=asc&sort=rank&min=gold&max=bronze&site=stackoverflow&filter=!-*f(6qLMLow-";
        BadgeItemInitializer bii = new BadgeItemInitializer(1, 100, 20160105, 20162005, Order.ASC, MaxMin.BRONZE,
